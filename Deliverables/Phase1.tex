...
<<<<<<< HEAD
<<<<<<< HEAD
\item RAM Car: If the user issues a command that would cause damage to the system, the
=======
\item Car: If the user issues a command that would cause damage to the system, the
>>>>>>> 8a03c34f25e2ca20d4bfd52ef1e8d2ba717b2dd8
=======
\item Car: If the user issues a command that would cause damage to the system, the
>>>>>>> 2cc96ab0f1463bcbf29a7655b7c50d65fe90fd07
=======
\item Car: If the user issues a command that would cause damage to the system, the
>>>>>>> 2cc96ab0f1463bcbf29a7655b7c50d65fe90fd07
