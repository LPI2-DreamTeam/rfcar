...
\item \underline{Software design}: for all required modules, and considering its
  ...
  \begin{itemize}
  \item \uline{front end level}: user interface software, providing a easy and convenient
  ...
  \item \uline{framework level}: software required to emulate/simulate and test the
    ...
    modules
  \item \uline{back end level}: software running \emph{behind the scenes}, handling user
