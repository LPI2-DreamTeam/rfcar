...
\begin{itemize}
\item \textbf{Customer Requirements}: Vehicle Integrity; Obstacle Avoidant; Reliable Feedback; Fast Response; Fast; Budget Friendly; Low Consumption; Small.
...
straightfoward guideline. For instance, the low cost requirement should be
