...
%
%IO_Entity.hpp
\lstinputlisting[language=C++, caption={IO\_Entity Interface},label=lst:io-entity-interface,
style=customc]{./listing/IO_Entity.hpp}
%
%IO_GPIO.hpp
\lstinputlisting[language=C++, caption={IO\_GPIO Interface},label=lst:io-GPIO-interface,
