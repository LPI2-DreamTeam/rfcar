...
On Fig.~\ref{fig:vision-class-diag} the class diagram of the remote vision subsystem is displayed. The Webcam and Telemetry class will be discussed more in depth. 
