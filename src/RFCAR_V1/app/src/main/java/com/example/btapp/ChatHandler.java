...
/*******************************************************************************************************
 ...
 MEMBER VARIABLES:   TAG: String (static final)
                     APP_NAME: String (static final)
                     MY_UUID: UUID (static final)
                     bluetoothAdapter: BluetoothAdapter (final)
                     handler: Handler (final)
                     acceptThread: AcceptThread (none)
                     connectThread: ConnectThread (none)
                     ioThread: IOThread (none)
                     state: int (none)
                     mContext: Context (none)
                     deviceUUID: UUID (none)
                     bluetoothDevice: BluetoothDevice (none)
                     buffer: byte[] (none)
                     LISTENING_STATE: int (static final)
                     CONNECTING_STATE: int (static final)
                     NO_STATE: int (static final)
                     CONNECTED_STATE: int (final)
