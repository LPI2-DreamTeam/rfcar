...
class SDP
{
    public:
        ...
        ~SDP();
        /**
         * @brief Tries to bind to all ports and returns the first available port
         * @return port
         * @param none
         */
        ...
        /**
         * @brief Finds the desired service and fills a vector with the service information.
         * @return void
         * @param name of service, service record vector
         *
         * Exceptions caller must catch:
         * - 1: hci_open_dev() fails to access the local bluetooth adapter
         * - 2: hci_inquiry() fails to find devices
         * - 3: sdp_connect() fails to connect to a device
         * - 4: sdp_service_search_attr_req() fails to communicate with the SDP server
         */
